...
下方的 [Function Structure](#function-structure) 小节给出了最小脚手架示例。若要查看社区构建的真实 Action 示例，可前往 [openwebui.com](https://openwebui.com/)。
...
**有关 Events 与 Event emitters 的完整说明，请参阅 [Events and Event Emitters](https://docs.openwebui.com/features/extensibility/plugin/events/)。**
...
- **Global Actions** —— 在 Action 设置中打开全局开关后，它会对所有用户与所有模型生效
- **Model-Specific Actions** —— 也可以在模型设置中仅为特定模型启用
