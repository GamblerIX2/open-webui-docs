...
关于 `__oauth_token__` 的更多信息，以及如何配置将该令牌传递给工具，请参阅 [环境变量文档页](https://docs.openwebui.com/reference/env-configuration/) 中的 OAuth 部分，以及 [SSO 文档](https://docs.openwebui.com/features/auth/)。
