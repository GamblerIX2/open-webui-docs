...
**解决方法：**
- 始终以官方 [environment configuration documentation](https://docs.openwebui.com/reference/env-configuration/) 为准
- 逐项检查你的部署环境：
...
对于生产环境中的 SSO 部署，请配置 Redis，或缩短 `JWT_EXPIRES_IN` 来降低暴露窗口。更多信息请参阅 [Token Revocation](/getting-started/advanced-topics/hardening#token-revocation) 和 [Redis tutorial](/tutorials/integrations/redis)。
:::
