...
**想更高效地获得帮助：**
1. **先搜索。** 先查看本文档、[Reddit](https://www.reddit.com/r/OpenWebUI/)、[GitHub Discussions](https://github.com/open-webui/open-webui/discussions) 和 [Issues](https://github.com/open-webui/open-webui/issues)——你的问题可能已经有人回答过。
2. **优先查看 GitHub Discussions。** 对于使用问题、部署思路或功能讨论，先在 [GitHub Discussions](https://github.com/open-webui/open-webui/discussions) 中搜索，通常能更快找到现成答案与上下文。
...
- 💬 **问题与帮助**：[Reddit](https://www.reddit.com/r/OpenWebUI/) 或 [GitHub Discussions](https://github.com/open-webui/open-webui/discussions)
...
如果你还有其他问题或疑虑，请前往我们的 [Reddit 社区](https://www.reddit.com/r/OpenWebUI/)、[GitHub Issues](https://github.com/open-webui/open-webui/issues) 或 [GitHub Discussions](https://github.com/open-webui/open-webui/discussions) 获取更多帮助与信息。请记住，所有社区互动都受我们的 **[行为准则](https://github.com/open-webui/open-webui/blob/main/CODE_OF_CONDUCT.md)** 约束。
